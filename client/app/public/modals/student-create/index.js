...
Template.publicModalStudentCreate.onRendered(function() {
  const self = this;

  const modalElement = document.getElementById('brdPublicModalStudentCreateModal');
  this.modal = new bootstrap.Modal(modalElement);

  modalElement.addEventListener('hidden.bs.modal', function (event) {
    AppUtil.temp.set('classId', null);
    self.$('form#brdPublicModalStudentCreateForm').trigger("reset");
  });
});

Template.publicModalStudentCreate.events({
